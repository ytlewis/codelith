  ...
  return (
    <section className="section-full relative z-10">
      <div className="text-left px-6 max-w-5xl mx-auto">
        <SplitText
          as="p"
          className="text-lg md:text-xl text-white/80 font-body mt-12 tracking-wide"
        ...
        <div className="mt-16 scroll-indicator">
          <div className="flex flex-col items-start gap-2 text-white/60">
            <span className="text-xs tracking-[0.3em] font-body">Descend Into The Atmosphere</span>
