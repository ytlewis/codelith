...
export const ImageSwiper: React.FC<ImageSwiperProps> = ({
  ...
  useEffect(() => {
    ...
    cardStackElement.addEventListener('pointercancel', handlePointerLeave);
    ...
    return () => {
      ...
      cardStackElement.removeEventListener('pointercancel', handlePointerLeave);
      if (animationFrameId.current) {
        cancelAnimationFrame(animationFrameId.current);
      }
    };
      ...
      {cardOrder.map((originalIndex, displayIndex) => (
        <article
          ...
          className="image-card absolute cursor-grab active:cursor-grabbing
                     place-self-center border border-border/60 rounded-xl
                     shadow-lg overflow-hidden will-change-transform bg-card/80"
          style={{
